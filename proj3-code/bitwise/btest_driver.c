        ...
        switch(message_tag) {
            case NEW_FUNC_TAG: {
                ...
                switch (function_id) {
                    ...
                    case COPY_LSB_TAG:
                    case IS_POSITIVE_TAG:
                    case FLOAT_NEGATE_TAG:
                    case ANY_EVEN_BIT_TAG:
                    case IS_ASCII_DIGIT_TAG:
                    case GREATEST_BIT_POS_TAG: {
                        num_args = 1;
                        break;
                    }

                    case FLOAT_IS_LESS_TAG:
                    case LOGICAL_SHIFT_TAG: {
                        num_args = 2;
                        break;
                    }
            ...
            case ARGS_TAG: {
                ...
                // Jump back to here if timeout occurs
                if (timeout_limit > 0) {
                ...
                switch(function_id) {
                    ...
                    case THIRD_BITS_TAG: {
                        return_val = thirdBits();
                        break;
                    }

                    case BYTE_SWAP_TAG: {
                        return_val = byteSwap(arg1, arg2, arg3);
                        break;
                    }

                    case COPY_LSB_TAG: {
                        return_val = copyLSB(arg1);
                        break;
                    }

                    case IS_POSITIVE_TAG: {
                        return_val = isPositive(arg1);
                        break;
                    }

                    case FLOAT_NEGATE_TAG: {
                        return_val = floatNegate(arg1);
                        break;
                    }

                    case ANY_EVEN_BIT_TAG: {
                        return_val = anyEvenBit(arg1);
                        break;
                    }
                    ...
                    case LOGICAL_SHIFT_TAG: {
                        return_val = logicalShift(arg1, arg2);
                        break;
                    }

                    case GREATEST_BIT_POS_TAG: {
                        return_val = greatestBitPos(arg1);
                        break;
                    }
